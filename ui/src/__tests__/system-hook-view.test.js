...
import { LjDataTable, LjConfirmDialog, useI18nStore } from '@ligoj/host'
...
const stubs = {
  ...
  LjConfirmDialog: { props: ['modelValue'], emits: ['confirm'], template: '<div v-if="modelValue" class="confirm"><slot /></div>' },
