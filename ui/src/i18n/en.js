...
export default {
  ...
  'system.plugin.toggleOn': "Enabled: new subscriptions to this tool are allowed (subscription mode {mode}). Click to disable: existing subscriptions keep working, no new subscription can be created.",
  'system.plugin.toggleOff': "Disabled: subscription mode NONE, no new subscription can be created. Click to enable (mode {mode}, the one of the refined node).",
  'system.plugin.toggleBlocked': "Disabled and cannot be enabled: the refined node {refined} has the subscription mode NONE. Enable it first.",
  'system.plugin.toggleUnavailable': "Unavailable: the plug-in is not loaded (missing resource), this tool cannot be toggled.",
  ...
  'system.plugin.confirmDisableText': "Disable {name}? Its subscription mode becomes NONE: existing subscriptions keep working, no new subscription can be created until it is enabled again.",
