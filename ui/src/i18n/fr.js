...
export default {
  ...
  'system.plugin.toggleOn': "Activé : les nouvelles souscriptions à cet outil sont autorisées (mode de souscription {mode}). Cliquer pour désactiver : les souscriptions existantes continuent de fonctionner, aucune nouvelle souscription ne peut être créée.",
  'system.plugin.toggleOff': "Désactivé : mode de souscription NONE, aucune nouvelle souscription ne peut être créée. Cliquer pour activer (mode {mode}, celui du nœud parent).",
  'system.plugin.toggleBlocked': "Désactivé et non activable : le nœud parent {refined} a le mode de souscription NONE. Activez-le d’abord.",
  'system.plugin.toggleUnavailable': "Indisponible : le plugin n’est pas chargé (ressource manquante), cet outil ne peut pas être basculé.",
  ...
  'system.plugin.confirmDisableText': "Désactiver {name} ? Son mode de souscription devient NONE : les souscriptions existantes continuent de fonctionner, aucune nouvelle souscription ne peut être créée jusqu’à sa réactivation.",
